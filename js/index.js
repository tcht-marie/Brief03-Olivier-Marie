...
window.addEventListener("load", () => {
    ...
    btn.addEventListener('click', (event) => {
        ...
        let filtredParams = "https://api.themoviedb.org/3/discover/movie?include_adult=false&include_video=false&language=fr-fr&page=1&primary_release_date.gte=" + dateJ + "&sort_by=primary_release_date.asc&with_genres=" + genreChoisisFetch;
    ...
    let generalParams = "https://api.themoviedb.org/3/discover/movie?include_adult=false&include_video=false&language=fr-fr&page=1&primary_release_date.gte=" + dateJ + "&sort_by=popularity";
